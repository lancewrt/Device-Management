    ...
    return (
        <div className="d-flex justify-content-center align-items-center w-100 min-vh-100" style={{margin: "auto"}}>
            ...
            <div className='col p-5 mt-5'>
                    ...
                    <div className='d-flex align-items-end gap-3 mb-3 mt-4'>
                        <FontAwesomeIcon icon={faComputer} size='3x' className='text-dark'/>
                        <h1 className='fw-semibold m-0 pt-3 text-dark '>Turn Over Device</h1>
                    </div>
                    <Card> 
                        <Card.Body>
                            ...
                            <div className="tab-content border-bottom border-start border-end " id="nav-tabContent">
                                ...
                                <div className="d-flex justify-content-end mb-3 pe-1">
                                    ...
                                    <Button 
                                        type='button' 
                                        className="d-flex align-items-center me-4 btn btn-secondary" 
                            ...
                            <div className="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                ...
                                <div className="d-flex justify-content-end mb-3 pe-1 gap-2">
                                    <Button 
                                        type='button' 
