...
import { faArrowLeft, faComputer } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <div className="d-flex justify-content-center align-items-center w-100 min-vh-100" style={{margin: "auto"}}>
            <div className="w-100 row h-100 bg-white" >
                ...
                <div className="d-flex justify-content-between align-items-center ms-3 mb-4">
                ...
                <div className='d-flex align-items-end gap-3 mb-3'>
                    ...
                    <h1 className='fw-semibold m-0 pt-3 text-dark'>Assign Device </h1>
                </div>
                <Card> 
                        <Card.Body>
                            ...
                            <div className="tab-content border-bottom border-start border-end " id="nav-tabContent">
                                ...
                                <div className="d-flex justify-content-end mb-3 pe-1">
                                    ...
                                    <Button 
                                        type='button' 
                                        className="d-flex align-items-center me-4 btn-secondary" 
                            ...
                            <div className="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                ...
                                <div className="d-flex justify-content-end mb-3 gap-2 pe-1">
                                    <Button 
                                        type='button' 
                            ...
                            <div className="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                                ...
                                <div className="d-flex justify-content-end mb-3 gap-2">
                                    ...
                                    >
                                        Finish 
                                        &nbsp;<ArrowRight className="me-2 btn-secondary" />
                                    </Button>
